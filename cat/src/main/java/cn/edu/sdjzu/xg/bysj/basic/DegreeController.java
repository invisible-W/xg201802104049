...
public class DegreeController extends HttpServlet {
    ...
    /**
     * POST, http://172.81.226.11 :8080/bysj1837/degree.ctl, 增加学位
    ...
    /**
     * DELETE, http://172.81.226.11 :8080/bysj1837/degree.ctl?id=1, 删除id=1的学位
    ...
    /**
     * PUT, http://172.81.226.11 :8080/bysj1837/degree.ctl, 修改学位
     * <p>
    ...
    /**
     * GET, http://172.81.226.11 :8080/bysj1837/degree.ctl?id=1, 查询id=1的学位
     * GET, http://172.81.226.11 :8080/bysj1837/degree.ctl, 查询所有的学位
     * 把一个或所有学位对象响应到前端
     *
     * @param request
     * @param response
